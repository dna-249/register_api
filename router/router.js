...
studentRouter.post('/:key/:value',studentSignup, postStudent)
...
managementRouter.post('/:key/:value',studentSignup, postManagement)
...
staffRouter.post('/:key/:value',studentSignup, postStaff)
